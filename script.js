window.addEventListener('scroll', function () {
    ...
    themeToggle.classList.toggle("sticky", window.scrollY > 10);
});

var prevScrollPos = window.scrollY+100;
const header = document.querySelector('header');

window.addEventListener("scroll", function() {
  var currentScrollPos = window.scrollY;
  header.classList.toggle("sticky", prevScrollPos < currentScrollPos);
